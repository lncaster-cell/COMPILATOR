...
void main()
{
    ...
    string sNav = "[DL DEBUG] nav_current=" + GetLocalString(oNpc, "dl_nav_debug_current") +
                  " nav_target=" + GetLocalString(oNpc, "dl_nav_debug_target") +
                  " nav_next=" + GetLocalString(oNpc, "dl_nav_debug_next") +
                  " nav_reason=" + GetLocalString(oNpc, "dl_nav_debug_reason") +
                  " stored_current=" + GetLocalString(oNpc, "dl_npc_nav_zone_current");
    DL_DbgSay(oPC, sNav);
}
