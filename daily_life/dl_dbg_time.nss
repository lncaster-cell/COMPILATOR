...
void main()
{
    ...
    DL_DbgSay(oPC,
        ...
        " focus_target_valid=" + DL_DbgBool(GetIsObjectValid(oFocusTarget)) +
    ...
    DL_DbgSay(oPC,
        "[DL DEBUG] transition_status=" + GetLocalString(oNpc, DL_L_NPC_TRANSITION_STATUS) +
    ...
    DL_DbgSay(oPC,
        ...
        " stored_area=" + GetLocalString(oNpc, "dl_npc_nav_zone_area")
    );
